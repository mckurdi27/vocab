...
async function loadData() {
    ...
    try {
        ...
        content.innerHTML = `<p style='color: #e74c3c; font-weight: bold;'>Dosya yüklenemedi. Lütfen 'data/${fileName}.json' dosyasının sunucuda küçük harfle var olduğundan emin olun.<br><small>${e.message}</small></p>`;
    }
}
